...
for ano in range(1990, 2025):
    ...
    while True:
        ...
        #Na hora de rodar o scraper, o rate-limit da API estourava toda hora e era impossível extrair os dados por completo, ele dava erro por volta de 2010
        #Visto isso, foi implementado esse proximo bloco, responsável por evitar que a API sobrecarregue, explicado abaixo nos comentarios
